    ...
    <table>
        <tr>
            <c:forEach items="${requestScope.page.urlList}" var="i" begin="0" end="4" varStatus="loop">
                <td>
                    <div class="deatil">
                        <span><a href="showPic.action?id=${requestScope.page.list[loop.count-1].id}&click=true"><img src="http://www.anhuiligong.com/web-image/thumbnai/${i}.jpg" class="img-rounded" width="200px" height="240px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    </div>
            ...
            <c:forEach items="${requestScope.page.urlList}" var="i" begin="5" end="10" varStatus="loop">
                ...
                <td>
                    <div class="deatil">
                        ...
                        <span><a href="showPic.action?id=${requestScope.page.list[loop.count+4].id}&click=true"><img src="http://www.anhuiligong.com/web-image/thumbnai/${i}.jpg" class="img-rounded" width="200px" height="240px"/></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    </div>
...
<c:if test="${requestScope.page.pageNum ==1}">
    <ul class="pagination">
        ...
        <c:forEach begin="${requestScope.page.start}" end="${requestScope.page.end}" step="1" var="i">
            ...
            <c:if test="${requestScope.page.pageNum != i}">
                <li><a href="showbyclick.action?pageNum=${i}">${i}</a></li>
            </c:if>
        </c:forEach>
        <li><a href="showbyclick.action?pageNum=${requestScope.page.pageNum+1}">&raquo;</a></li>
    </ul>
</c:if>
<%--如果当前页不是第一页也不是最后一页，则有上一页和下一页这个超链接显示 --%>
<c:if test="${requestScope.page.pageNum > 1 && requestScope.page.pageNum < requestScope.page.totalPage}">
    <ul class="pagination">
        <li ><a href="showbyclick.action?pageNum=${requestScope.page.pageNum-1}">&laquo;</a></li>
